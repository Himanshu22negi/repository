...
function extractBirthdays(body) {
    ...
    let allRows = document.querySelectorAll(".ds-text-title-s.ds-font-bold.ds-text-ui-typo");
    
        let singlePlayerDetailElem = allRows[1];
        console.log(singlePlayerDetailElem);
}